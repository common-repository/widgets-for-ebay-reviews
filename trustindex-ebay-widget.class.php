...
echo $trustindex_pm_ebay->renderWidgetFrontend($instance['ti-widget-ID']);
} else if ($trustindex_pm_ebay->is_noreg_linked()) {
echo $trustindex_pm_ebay->renderWidgetFrontend();
} else {
echo $trustindex_pm_ebay->frontEndErrorForAdmins(sprintf(__("Please fill out <strong>all the required fields</strong> in the <a href='%s'>widget settings</a> page", 'trustindex-plugin'), admin_url('admin.php?page='.$trustindex_pm_ebay->get_plugin_slug().'/settings.php')));
}
echo $after_widget;
} else {
}
