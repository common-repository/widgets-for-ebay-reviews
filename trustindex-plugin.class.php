...
$chosedPlatform = new $className($forcePlatform, $filePath, "do-not-care-12.4.1", "do-not-care-Widgets for Ebay Reviews", "do-not-care-Ebay");
...
$ratingContent = '<img class="ti-polarity-icon" src="https://cdn.trustindex.io/assets/platform/Ebay/'. $polarity .'.svg" alt="Ebay" width="15" height="15" loading="lazy" />';
}
}
